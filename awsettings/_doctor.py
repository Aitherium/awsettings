"""Stack-aware `doctor` for awsettings.
...
interesting failures live BETWEEN them. "awsettings is installed" is not the useful
fact -- "awsettings is installed and the thing it pairs with is not" is. This reports
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWSETTINGS_BACKEND_PROFILES', 'AWSETTINGS_DOMAIN', 'AWSETTINGS_ENVELOPE', 'AWSETTINGS_LAUNCHER_BIN', 'AWSETTINGS_MODS_FILE', 'AWSETTINGS_PROBE_TOKEN', 'AWSETTINGS_PROFILE', 'AWSETTINGS_PUBLIC_KEY', 'AWSETTINGS_REQUIRE_SEAL', 'AWSETTINGS_SECRET_CMD', 'AWSETTINGS_TOKEN', 'AWSETTINGS_TOKEN_FILE', 'AWSETTINGS_URL']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awsettings needs at runtime, and a
