...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWSETTINGS_BACKEND_PROFILES', 'AWSETTINGS_LAUNCHER_BIN', 'AWSETTINGS_PROBE_TOKEN', 'AWSETTINGS_PROFILE', 'AWSETTINGS_PUBLIC_KEY', 'AWSETTINGS_REQUIRE_SEAL', 'AWSETTINGS_SECRET_CMD', 'AWSETTINGS_TOKEN', 'AWSETTINGS_URL']
